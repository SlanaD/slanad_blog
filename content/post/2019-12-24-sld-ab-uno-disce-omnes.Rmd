...
_It's simple, but simple isn't the same as easy_  


_Old Man's War (John Scalzi)_ 



![](/images/2019-12-24_barcode.gif){width=15%}  

</center>  

Tukaj sem nametal nekaj skriptov, za katere se mi zdi, da jih bom še potreboval.

RMD narediš lahko malo lepši s pomočjo [teh navodil](https://holtzy.github.io/Pimp-my-rmd/)
...
Narediš datoteko s končnico *.CMD (npr. _zagon.cmd_) .
...
Narediš datoteko s končnico *.CMD (npr. _ED.cmd_). Kjer nastaviš, kako boš zaganjal VBS. V osnovi lahko zaženeš VBS direktno, samo potem ne veš ali se bo izvršil 32bitni ali 64bitni. Odvisno od nastavitve v računalniku
...
Naslednji del pa je, da pripraviš datoteko VBS (npr. _ED.vbs_) in z njo zaženeš pythonove skripte. VBS script ima določene prednosti pri nekaterih opravilih v windowsih, zato je včasih kombinacija smiselna. Če ne drugje, ko krpaš skupaj kaj novega in obstoječega.
